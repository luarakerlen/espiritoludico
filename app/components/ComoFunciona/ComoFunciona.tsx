...
export default function ComoFunciona() {
  ...
  const openWhatsApp = (message: string = "Olá! Gostaria de saber como funciona o aluguel de jogos.") => {
      ...
      <div className={styles.container}>
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Alugar jogos de tabuleiro nunca foi tão fácil! Siga nossos 4 passos simples 
            e comece a se divertir hoje mesmo.
          </p>
        </div>
        ...
        <div className={styles.cta}>
          <div className={styles.ctaContent}>
            ...
            <p>
              Temos especialistas prontos para te ajudar a escolher o jogo perfeito 
              para sua família, amigos ou evento.
            </p>
        ...
        <div className={styles.benefits}>
          ...
          <div className={styles.benefit}>
            ...
            <div>
              ...
              <p>Mais de 100 jogos diferentes para escolher</p>
            </div>
          </div>
          <div className={styles.benefit}>
            <span className={styles.benefitIcon}>💬</span>
            <div>
              <h4>Suporte Total</h4>
              <p>Ajuda para escolher e regras explicadas</p>
            </div>
          </div>
        </div>
      </div>
